...
@section('content')
    <div class="page-crud-header d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a class="btn btn-primary btn-add" href="https://docs.google.com/spreadsheets/d/1T0C8mc1QFMEwuZJaQlM8iEPN45vZPa1Kp52X56nPtCA/edit?usp=sharing" target="_blank" rel="noopener" style="text-decoration:none;"><i class="fa-solid fa-arrow-up-right-from-square"></i> Open Spreadsheet</a>
